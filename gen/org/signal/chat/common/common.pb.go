...
const file_org_signal_chat_common_proto_rawDesc = "" +
	...
	"\x04uuid\x18\x02 \x01(\fB\x05\xa2\x97\"\x01\x10R\x04uuid\"\xa9\x01\n" +
	"\x12AccountIdentifiers\x12Z\n" +
	"\x13service_identifiers\x18\x01 \x03(\v2).org.signal.chat.common.ServiceIdentifierR\x12serviceIdentifiers\x12\x12\n" +
	"\x04e164\x18\x02 \x01(\tR\x04e164\x12#\n" +
	"\rusername_hash\x18\x03 \x01(\fR\fusernameHash\"N\n" +
	"\bEcPreKey\x12\x1d\n" +
	...
	"\x11IDENTITY_TYPE_PNI\x10\x02*\xbb\x02\n" +
	...
	".DEVICE_CAPABILITY_USERNAME_CHANGE_SYNC_MESSAGE\x10\t\"\x04\b\x03\x10\x03\"\x04\b\x04\x10\x04\"\x04\b\x05\x10\x05B\xed\x01\n" +
	"\x1acom.org.signal.chat.commonB\vCommonProtoP\x01ZFgithub.com/GoCodeAlone/libsignal-service-go/gen/org/signal/chat/common\xa2\x02\x04OSCC\xaa\x02\x16Org.Signal.Chat.Common\xca\x02\x16Org\\Signal\\Chat\\Common\xe2\x02\"Org\\Signal\\Chat\\Common\\GPBMetadata\xea\x02\x19Org::Signal::Chat::Commonb\x06proto3"
