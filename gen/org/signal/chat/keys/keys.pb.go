...
const file_org_signal_chat_keys_proto_rawDesc = "" +
	...
	"\x0fregistration_id\x18\x04 \x01(\rR\x0eregistrationId\"\x8c\x02\n" +
	"\x14AccountPreKeyBundles\x12!\n" +
	"\fidentity_key\x18\x01 \x01(\fR\videntityKey\x12e\n" +
	"\x0fdevice_pre_keys\x18\x02 \x03(\v2=.org.signal.chat.keys.AccountPreKeyBundles.DevicePreKeysEntryR\rdevicePreKeys\x1aj\n" +
	...
	"\x11target_identifier\x18\x01 \x01(\v2).org.signal.chat.common.ServiceIdentifierR\x10targetIdentifier\x12!\n" +
	"\fidentity_key\x18\x02 \x01(\fR\videntityKey2\xb9\x05\n" +
	"\x04Keys\x12m\n" +
	...
	"\x16SetKemLastResortPreKey\x123.org.signal.chat.keys.SetKemLastResortPreKeyRequest\x1a'.org.signal.chat.keys.SetPreKeyResponse\"\x002\xfe\x01\n" +
	"\rKeysAnonymous\x12s\n" +
	"\n" +
	...
	"\x11CheckIdentityKeys\x12-.org.signal.chat.keys.CheckIdentityKeyRequest\x1a..org.signal.chat.keys.CheckIdentityKeyResponse\"\x00(\x010\x01B\xdf\x01\n" +
	"\x18com.org.signal.chat.keysB\tKeysProtoP\x01ZDgithub.com/GoCodeAlone/libsignal-service-go/gen/org/signal/chat/keys\xa2\x02\x04OSCK\xaa\x02\x14Org.Signal.Chat.Keys\xca\x02\x14Org\\Signal\\Chat\\Keys\xe2\x02 Org\\Signal\\Chat\\Keys\\GPBMetadata\xea\x02\x17Org::Signal::Chat::Keysb\x06proto3"
