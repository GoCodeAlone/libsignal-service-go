...
import (
	...
	textsecure "github.com/GoCodeAlone/libsignal-service-go/gen/textsecure"
...
func (x *GetMessagesResponse) GetEnvelope() *textsecure.Envelope {
	if x != nil {
...
type GetMessagesResponse_Envelope struct {
	...
	// open RPC.
	Envelope *textsecure.Envelope `protobuf:"bytes,1,opt,name=envelope,proto3,oneof"`
}
...
const file_org_signal_chat_messages_proto_rawDesc = "" +
	"\n" +
	"\x1eorg/signal/chat/messages.proto\x12\x18org.signal.chat.messages\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1corg/signal/chat/common.proto\x1a\x1dorg/signal/chat/require.proto\x1a\x1corg/signal/chat/errors.proto\x1a\x19org/signal/chat/tag.proto\x1a\x10TextSecure.proto\"\xdd\x01\n" +
	...
	"\benvelope\x18\x01 \x01(\v2\x14.textsecure.EnvelopeH\x00R\benvelope\x129\n" +
	...
	"\x12service_identifier\x18\x01 \x01(\v2).org.signal.chat.common.ServiceIdentifierR\x11serviceIdentifier\x12/\n" +
	"\x0fmissing_devices\x18\x02 \x03(\rB\x06\xb2\x97\"\x02\x10\x7fR\x0emissingDevices\x12+\n" +
	"\rextra_devices\x18\x03 \x03(\rB\x06\xb2\x97\"\x02\x10\x7fR\fextraDevices\x12+\n" +
	"\rstale_devices\x18\x04 \x03(\rB\x06\xb2\x97\"\x02\x10\x7fR\fstaleDevices\"}\n" +
	...
	"\x17SendMultiRecipientStory\x128.org.signal.chat.messages.SendMultiRecipientStoryRequest\x1a;.org.signal.chat.messages.SendMultiRecipientMessageResponse\"\x00\x1a\x04\xc8\xd5\"\x02B\xfb\x01\n" +
	"\x1ccom.org.signal.chat.messagesB\rMessagesProtoP\x01ZHgithub.com/GoCodeAlone/libsignal-service-go/gen/org/signal/chat/messages\xa2\x02\x04OSCM\xaa\x02\x18Org.Signal.Chat.Messages\xca\x02\x18Org\\Signal\\Chat\\Messages\xe2\x02$Org\\Signal\\Chat\\Messages\\GPBMetadata\xea\x02\x1bOrg::Signal::Chat::Messagesb\x06proto3"
...
var file_org_signal_chat_messages_proto_goTypes = []any{
	...
	(*textsecure.Envelope)(nil),      // 24: textsecure.Envelope
...
var file_org_signal_chat_messages_proto_depIdxs = []int32{
	...
	24, // 2: org.signal.chat.messages.GetMessagesResponse.envelope:type_name -> textsecure.Envelope
