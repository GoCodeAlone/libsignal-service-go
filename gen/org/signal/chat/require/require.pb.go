...
var (
	...
	E_Auth = &file_org_signal_chat_require_proto_extTypes[9]
)
...
const file_org_signal_chat_require_proto_rawDesc = "" +
	"\n" +
	"\x1dorg/signal/chat/require.proto\x12\x17org.signal.chat.require\x1a google/protobuf/descriptor.proto\"N\n" +
	...
	"\fidentityType\x12\x1d.google.protobuf.FieldOptions\x18\xf9\xa2\x04 \x01(\x0e2%.org.signal.chat.require.IdentityTypeR\fidentityType\x88\x01\x01:W\n" +
	"\x04auth\x12\x1f.google.protobuf.ServiceOptions\x18٪\x04 \x01(\x0e2\x1d.org.signal.chat.require.AuthR\x04auth\x88\x01\x01B\xf6\x01\n" +
	"\x1bcom.org.signal.chat.requireB\fRequireProtoP\x01ZGgithub.com/GoCodeAlone/libsignal-service-go/gen/org/signal/chat/require\xa2\x02\x04OSCR\xaa\x02\x17Org.Signal.Chat.Require\xca\x02\x18Org\\Signal\\Chat\\Require_\xe2\x02$Org\\Signal\\Chat\\Require_\\GPBMetadata\xea\x02\x1aOrg::Signal::Chat::Requireb\x06proto3"
...
var file_org_signal_chat_require_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_org_signal_chat_require_proto_goTypes = []any{
	...
	(*SizeConstraint)(nil),              // 2: org.signal.chat.require.SizeConstraint
	(*ValueRangeConstraint)(nil),        // 3: org.signal.chat.require.ValueRangeConstraint
...
var file_org_signal_chat_require_proto_depIdxs = []int32{
	4,  // 0: org.signal.chat.require.nonEmpty:extendee -> google.protobuf.FieldOptions
	4,  // 1: org.signal.chat.require.specified:extendee -> google.protobuf.FieldOptions
	4,  // 2: org.signal.chat.require.size:extendee -> google.protobuf.FieldOptions
	4,  // 3: org.signal.chat.require.exactlySize:extendee -> google.protobuf.FieldOptions
	4,  // 4: org.signal.chat.require.e164:extendee -> google.protobuf.FieldOptions
	4,  // 5: org.signal.chat.require.range:extendee -> google.protobuf.FieldOptions
	4,  // 6: org.signal.chat.require.present:extendee -> google.protobuf.FieldOptions
	4,  // 7: org.signal.chat.require.base64url:extendee -> google.protobuf.FieldOptions
	4,  // 8: org.signal.chat.require.identityType:extendee -> google.protobuf.FieldOptions
	5,  // 9: org.signal.chat.require.auth:extendee -> google.protobuf.ServiceOptions
	2,  // 10: org.signal.chat.require.size:type_name -> org.signal.chat.require.SizeConstraint
	3,  // 11: org.signal.chat.require.range:type_name -> org.signal.chat.require.ValueRangeConstraint
	1,  // 12: org.signal.chat.require.identityType:type_name -> org.signal.chat.require.IdentityType
	0,  // 13: org.signal.chat.require.auth:type_name -> org.signal.chat.require.Auth
