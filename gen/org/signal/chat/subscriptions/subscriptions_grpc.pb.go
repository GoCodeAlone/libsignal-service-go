...
const (
	Subscriptions_UpdateSubscriber_FullMethodName           = "/org.signal.chat.subscriptions.Subscriptions/UpdateSubscriber"
	Subscriptions_DeleteSubscriber_FullMethodName           = "/org.signal.chat.subscriptions.Subscriptions/DeleteSubscriber"
	Subscriptions_CreatePaymentMethod_FullMethodName        = "/org.signal.chat.subscriptions.Subscriptions/CreatePaymentMethod"
	Subscriptions_CreatePayPalPaymentMethod_FullMethodName  = "/org.signal.chat.subscriptions.Subscriptions/CreatePayPalPaymentMethod"
	Subscriptions_SetDefaultPaymentMethod_FullMethodName    = "/org.signal.chat.subscriptions.Subscriptions/SetDefaultPaymentMethod"
	Subscriptions_SetSubscriptionLevel_FullMethodName       = "/org.signal.chat.subscriptions.Subscriptions/SetSubscriptionLevel"
	Subscriptions_GetSubscriptionInformation_FullMethodName = "/org.signal.chat.subscriptions.Subscriptions/GetSubscriptionInformation"
	Subscriptions_GetReceiptCredentials_FullMethodName      = "/org.signal.chat.subscriptions.Subscriptions/GetReceiptCredentials"
	Subscriptions_SetIapSubscription_FullMethodName         = "/org.signal.chat.subscriptions.Subscriptions/SetIapSubscription"
	Subscriptions_GetConfiguration_FullMethodName           = "/org.signal.chat.subscriptions.Subscriptions/GetConfiguration"
	Subscriptions_GetBankMandate_FullMethodName             = "/org.signal.chat.subscriptions.Subscriptions/GetBankMandate"
)
...
func (c *subscriptionsClient) GetConfiguration(ctx context.Context, in *GetConfigurationRequest, opts ...grpc.CallOption) (*GetConfigurationResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetConfigurationResponse)
	err := c.cc.Invoke(ctx, Subscriptions_GetConfiguration_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedSubscriptionsServer) GetConfiguration(context.Context, *GetConfigurationRequest) (*GetConfigurationResponse, error) {
...
func _Subscriptions_GetConfiguration_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetConfigurationRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SubscriptionsServer).GetConfiguration(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Subscriptions_GetConfiguration_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SubscriptionsServer).GetConfiguration(ctx, req.(*GetConfigurationRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Subscriptions_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "org.signal.chat.subscriptions.Subscriptions",
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Subscriptions_GetConfiguration_Handler,
		},
		{
