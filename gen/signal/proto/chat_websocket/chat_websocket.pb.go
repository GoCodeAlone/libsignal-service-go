...
func (WebSocketMessage_Type) Descriptor() protoreflect.EnumDescriptor {
	return file_chat_websocket_proto_enumTypes[0].Descriptor()
}

func (WebSocketMessage_Type) Type() protoreflect.EnumType {
	return &file_chat_websocket_proto_enumTypes[0]
}
...
func (WebSocketMessage_Type) EnumDescriptor() ([]byte, []int) {
	return file_chat_websocket_proto_rawDescGZIP(), []int{2, 0}
}
...
func (x *WebSocketRequestMessage) Reset() {
	*x = WebSocketRequestMessage{}
	mi := &file_chat_websocket_proto_msgTypes[0]
...
func (*WebSocketRequestMessage) Descriptor() ([]byte, []int) {
	return file_chat_websocket_proto_rawDescGZIP(), []int{0}
}
...
func (x *WebSocketResponseMessage) Reset() {
	*x = WebSocketResponseMessage{}
	mi := &file_chat_websocket_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*WebSocketResponseMessage) Descriptor() ([]byte, []int) {
	return file_chat_websocket_proto_rawDescGZIP(), []int{1}
}
...
type WebSocketMessage struct {
	state         protoimpl.MessageState    `protogen:"open.v1"`
	Type          *WebSocketMessage_Type    `protobuf:"varint,1,opt,name=type,enum=signal.proto.chat_websocket.WebSocketMessage_Type" json:"type,omitempty"`
...
func (x *WebSocketMessage) Reset() {
	*x = WebSocketMessage{}
	mi := &file_chat_websocket_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*WebSocketMessage) Descriptor() ([]byte, []int) {
	return file_chat_websocket_proto_rawDescGZIP(), []int{2}
}
...
var File_chat_websocket_proto protoreflect.FileDescriptor

const file_chat_websocket_proto_rawDesc = "" +
	"\n" +
	"\x14chat_websocket.proto\x12\x1bsignal.proto.chat_websocket\"\x7f\n" +
	...
	"\x04body\x18\x04 \x01(\fR\x04body\"\xad\x02\n" +
	"\x10WebSocketMessage\x12F\n" +
	"\x04type\x18\x01 \x01(\x0e22.signal.proto.chat_websocket.WebSocketMessage.TypeR\x04type\x12N\n" +
	"\arequest\x18\x02 \x01(\v24.signal.proto.chat_websocket.WebSocketRequestMessageR\arequest\x12Q\n" +
	"\bresponse\x18\x03 \x01(\v25.signal.proto.chat_websocket.WebSocketResponseMessageR\bresponse\".\n" +
	"\x04Type\x12\v\n" +
	"\aUNKNOWN\x10\x00\x12\v\n" +
	"\aREQUEST\x10\x01\x12\f\n" +
	"\bRESPONSE\x10\x02B\x8c\x02\n" +
	"\x1fcom.signal.proto.chat_websocketB\x12ChatWebsocketProtoP\x01ZKgithub.com/GoCodeAlone/libsignal-service-go/gen/signal/proto/chat_websocket\xa2\x02\x03SPC\xaa\x02\x1aSignal.Proto.ChatWebsocket\xca\x02\x1aSignal\\Proto\\ChatWebsocket\xe2\x02&Signal\\Proto\\ChatWebsocket\\GPBMetadata\xea\x02\x1cSignal::Proto::ChatWebsocket"

var (
	file_chat_websocket_proto_rawDescOnce sync.Once
	file_chat_websocket_proto_rawDescData []byte
)

func file_chat_websocket_proto_rawDescGZIP() []byte {
	file_chat_websocket_proto_rawDescOnce.Do(func() {
		file_chat_websocket_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_chat_websocket_proto_rawDesc), len(file_chat_websocket_proto_rawDesc)))
	})
	return file_chat_websocket_proto_rawDescData
}

var file_chat_websocket_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_chat_websocket_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_chat_websocket_proto_goTypes = []any{
	(WebSocketMessage_Type)(0),       // 0: signal.proto.chat_websocket.WebSocketMessage.Type
	(*WebSocketRequestMessage)(nil),  // 1: signal.proto.chat_websocket.WebSocketRequestMessage
	(*WebSocketResponseMessage)(nil), // 2: signal.proto.chat_websocket.WebSocketResponseMessage
	(*WebSocketMessage)(nil),         // 3: signal.proto.chat_websocket.WebSocketMessage
}
var file_chat_websocket_proto_depIdxs = []int32{
	0, // 0: signal.proto.chat_websocket.WebSocketMessage.type:type_name -> signal.proto.chat_websocket.WebSocketMessage.Type
	1, // 1: signal.proto.chat_websocket.WebSocketMessage.request:type_name -> signal.proto.chat_websocket.WebSocketRequestMessage
	2, // 2: signal.proto.chat_websocket.WebSocketMessage.response:type_name -> signal.proto.chat_websocket.WebSocketResponseMessage
...
func init() { file_chat_websocket_proto_init() }
func file_chat_websocket_proto_init() {
	if File_chat_websocket_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_chat_websocket_proto_rawDesc), len(file_chat_websocket_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_chat_websocket_proto_goTypes,
		DependencyIndexes: file_chat_websocket_proto_depIdxs,
		EnumInfos:         file_chat_websocket_proto_enumTypes,
		MessageInfos:      file_chat_websocket_proto_msgTypes,
	}.Build()
	File_chat_websocket_proto = out.File
	file_chat_websocket_proto_goTypes = nil
	file_chat_websocket_proto_depIdxs = nil
}
